...
var RenderXTip = function RenderXTip(props) {
  ...
  return jsx("rect", {
    ...
    style: __assign(__assign({}, xTipTextStyle), {
      text: xPositionType === 'coord' ? coordData.xText : isFunction(xTip) ? xTip(xFirstText) : xFirstText
    })
  }));
};
var RenderYTip = function RenderYTip(props) {
  ...
  return jsx("rect", {
    ...
    style: __assign(__assign({}, yTipTextStyle), {
      text: yPositionType === 'coord' ? coordData.yText : isFunction(yTip) ? yTip(yFirstText) : yFirstText
    })
  }));
};
// tooltip 内容框
...
var TooltipView = /** @class */function (_super) {
  ...
  TooltipView.prototype.render = function () {
    ...
    var itemMarkerStyle = __assign(__assign({}, customItemMarkerStyle), defaultStyle.itemMarkerStyle);
